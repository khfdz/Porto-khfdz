    ...
    return (
        <div className='bg-color1 pb-10 pt-10 font-sourceSans text-xl'>
            ...
            <div className='mt-10'>
                ...
                <a href='https://drive.google.com/file/d/1XWTjLRuGXLAesDvluVuLaGSzmhJ_fwzM/view' download="CV-ATS_Dhika_Hafidz.pdf" className='bg-color2 p-4 text-2xl font-extrabold rounded-r-3xl font-playfair left-0 absolute ml-auto mt-[10px] hover:text-white'>CV ATS</a>
            </div>
